"""Static exercise-name and template-id tables for the Hevy mapper.

HEVY_TO_GARMIN is copied verbatim from hevy2garmin (MIT,
github.com/secunit404/hevy2garmin). TEMPLATE_OVERRIDES corrects the
auto-generated TEMPLATE_TO_GARMIN table, which is also re-copied verbatim, so

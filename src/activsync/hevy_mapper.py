...
The HEVY_TO_GARMIN name table is copied verbatim from hevy2garmin (MIT,
github.com/secunit404/hevy2garmin). ActivSync's lookup differs from upstream:
user mappings live in the exercise_mappings table (not a JSON file), a miss
raises MappingMiss instead of returning the UNKNOWN sentinel (the mapping gate
